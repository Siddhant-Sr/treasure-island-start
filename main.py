...
if ready == "Y":
  print("let's go.")
  dir = input("Press R for right and L for left\n")
  if dir == "R":
    ...
    .   .   ,        .    + c  ,   `:.,:"        , "   d8'               d8.    :
      ...
      ,    8b.__. ,  .n8688b., .    .;:._     .___nn898868n.         n868b "`   8
        ...
        ,     88b.       `+88.     `   ` '     .889"'           ,.88'        .,88
          ...
          mh '. .                 88.     `8898        " .889"'              .988
  ''')
    print("GAME OVER. You are killed by tiger.")
  elif dir == "L":
    print("You are on the right way")
    fdir = input("Press S for straight, R for right, L for left\n")
    if fdir == "S":
      print("You are drowned in the lake")
    elif fdir == "R":
      print("Congrats")
      print('''
    *******************************************************************************
